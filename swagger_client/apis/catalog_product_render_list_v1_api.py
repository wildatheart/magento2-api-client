...
class CatalogProductRenderListV1Api(object):
    """
    ...
    def catalog_product_render_list_v1_get_list_get(self, store_id, currency_code, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_product_render_list_v1_get_list_get(store_id, currency_code, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.catalog_product_render_list_v1_get_list_get_with_http_info(store_id, currency_code, **kwargs)
        else:
            (data) = self.catalog_product_render_list_v1_get_list_get_with_http_info(store_id, currency_code, **kwargs)
            return data

    def catalog_product_render_list_v1_get_list_get_with_http_info(self, store_id, currency_code, **kwargs):
        """
        Collect and retrieve the list of product render info This info contains raw prices and formated prices, product name, stock status, store_id, etc
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_product_render_list_v1_get_list_get_with_http_info(store_id, currency_code, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method catalog_product_render_list_v1_get_list_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'store_id' is set
        if ('store_id' not in params) or (params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `catalog_product_render_list_v1_get_list_get`")
        # verify the required parameter 'currency_code' is set
        if ('currency_code' not in params) or (params['currency_code'] is None):
            raise ValueError("Missing the required parameter `currency_code` when calling `catalog_product_render_list_v1_get_list_get`")
        ...
        if 'currency_code' in params:
            query_params.append(('currencyCode', params['currency_code']))
        ...
        return self.api_client.call_api('/V1/products-render-info', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='CatalogDataProductRenderSearchResultsInterface',
