...
class QuoteCartRepositoryV1Api(object):
    """
    ...
    def quote_cart_repository_v1_get_get(self, cart_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_get_get(cart_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.quote_cart_repository_v1_get_get_with_http_info(cart_id, **kwargs)
        else:
            (data) = self.quote_cart_repository_v1_get_get_with_http_info(cart_id, **kwargs)
            return data

    def quote_cart_repository_v1_get_get_with_http_info(self, cart_id, **kwargs):
        """
        Enables an administrative user to return information for a specified cart.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_get_get_with_http_info(cart_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method quote_cart_repository_v1_get_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cart_id' is set
        if ('cart_id' not in params) or (params['cart_id'] is None):
            raise ValueError("Missing the required parameter `cart_id` when calling `quote_cart_repository_v1_get_get`")
        ...
        return self.api_client.call_api('/V1/carts/{cartId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def quote_cart_repository_v1_get_list_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_get_list_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.quote_cart_repository_v1_get_list_get_with_http_info(**kwargs)
        else:
            (data) = self.quote_cart_repository_v1_get_list_get_with_http_info(**kwargs)
            return data

    def quote_cart_repository_v1_get_list_get_with_http_info(self, **kwargs):
        """
        Enables administrative users to list carts that match specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included.  See http://devdocs.magento.com/codelinks/attributes.html#CartRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_get_list_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method quote_cart_repository_v1_get_list_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/V1/carts/search', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='QuoteDataCartSearchResultsInterface',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def quote_cart_repository_v1_save_put(self, **kwargs):
        """
        Save quote
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_save_put(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.quote_cart_repository_v1_save_put_with_http_info(**kwargs)
        else:
            (data) = self.quote_cart_repository_v1_save_put_with_http_info(**kwargs)
            return data

    def quote_cart_repository_v1_save_put_with_http_info(self, **kwargs):
        """
        Save quote
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.quote_cart_repository_v1_save_put_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method quote_cart_repository_v1_save_put" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/V1/carts/mine', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
