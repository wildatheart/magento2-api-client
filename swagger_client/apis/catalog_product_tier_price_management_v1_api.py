...
class CatalogProductTierPriceManagementV1Api(object):
    ...
    def catalog_product_tier_price_management_v1_add_post_with_http_info(self, sku, customer_group_id, price, qty, **kwargs):
        ...
        return self.api_client.call_api('/V1/products/{sku}/group-prices/{customerGroupId}/tiers/{qty}/price/{price}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def catalog_product_tier_price_management_v1_get_list_get_with_http_info(self, sku, customer_group_id, **kwargs):
        ...
        return self.api_client.call_api('/V1/products/{sku}/group-prices/{customerGroupId}/tiers', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[CatalogDataProductTierPriceInterface]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def catalog_product_tier_price_management_v1_remove_delete_with_http_info(self, sku, customer_group_id, qty, **kwargs):
        ...
        return self.api_client.call_api('/V1/products/{sku}/group-prices/{customerGroupId}/tiers/{qty}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
