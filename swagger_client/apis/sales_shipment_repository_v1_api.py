...
class SalesShipmentRepositoryV1Api(object):
    """
    ...
    def sales_shipment_repository_v1_get_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_get_get(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.sales_shipment_repository_v1_get_get_with_http_info(id, **kwargs)
        else:
            (data) = self.sales_shipment_repository_v1_get_get_with_http_info(id, **kwargs)
            return data

    def sales_shipment_repository_v1_get_get_with_http_info(self, id, **kwargs):
        """
        Loads a specified shipment.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_get_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method sales_shipment_repository_v1_get_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sales_shipment_repository_v1_get_get`")
        ...
        return self.api_client.call_api('/V1/shipment/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='SalesDataShipmentInterface',
    ...
    def sales_shipment_repository_v1_get_list_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_get_list_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.sales_shipment_repository_v1_get_list_get_with_http_info(**kwargs)
        else:
            (data) = self.sales_shipment_repository_v1_get_list_get_with_http_info(**kwargs)
            return data

    def sales_shipment_repository_v1_get_list_get_with_http_info(self, **kwargs):
        """
        Lists shipments that match specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See http://devdocs.magento.com/codelinks/attributes.html#ShipmentRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_get_list_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sales_shipment_repository_v1_get_list_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/V1/shipments', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='SalesDataShipmentSearchResultInterface',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def sales_shipment_repository_v1_save_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_save_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.sales_shipment_repository_v1_save_post_with_http_info(**kwargs)
        else:
            (data) = self.sales_shipment_repository_v1_save_post_with_http_info(**kwargs)
            return data

    def sales_shipment_repository_v1_save_post_with_http_info(self, **kwargs):
        """
        Performs persist operations for a specified shipment.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sales_shipment_repository_v1_save_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sales_shipment_repository_v1_save_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/V1/shipment/', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
