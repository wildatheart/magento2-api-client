...
class CatalogCategoryAttributeRepositoryV1Api(object):
    """
    ...
    def catalog_category_attribute_repository_v1_get_get(self, attribute_code, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_category_attribute_repository_v1_get_get(attribute_code, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.catalog_category_attribute_repository_v1_get_get_with_http_info(attribute_code, **kwargs)
        else:
            (data) = self.catalog_category_attribute_repository_v1_get_get_with_http_info(attribute_code, **kwargs)
            return data

    def catalog_category_attribute_repository_v1_get_get_with_http_info(self, attribute_code, **kwargs):
        """
        Retrieve specific attribute
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_category_attribute_repository_v1_get_get_with_http_info(attribute_code, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method catalog_category_attribute_repository_v1_get_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'attribute_code' is set
        if ('attribute_code' not in params) or (params['attribute_code'] is None):
            raise ValueError("Missing the required parameter `attribute_code` when calling `catalog_category_attribute_repository_v1_get_get`")
        ...
        return self.api_client.call_api('/V1/categories/attributes/{attributeCode}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='CatalogDataCategoryAttributeInterface',
    ...
    def catalog_category_attribute_repository_v1_get_list_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_category_attribute_repository_v1_get_list_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.catalog_category_attribute_repository_v1_get_list_get_with_http_info(**kwargs)
        else:
            (data) = self.catalog_category_attribute_repository_v1_get_list_get_with_http_info(**kwargs)
            return data

    def catalog_category_attribute_repository_v1_get_list_get_with_http_info(self, **kwargs):
        """
        Retrieve all attributes for entity type
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.catalog_category_attribute_repository_v1_get_list_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method catalog_category_attribute_repository_v1_get_list_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/V1/categories/attributes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='CatalogDataCategoryAttributeSearchResultsInterface',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
