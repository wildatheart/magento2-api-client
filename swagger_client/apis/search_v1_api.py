...
class SearchV1Api(object):
    ...
    def search_v1_search_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.search_v1_search_get(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str search_criteria_request_name:
        ...
        if kwargs.get('callback'):
            return self.search_v1_search_get_with_http_info(**kwargs)
        else:
            (data) = self.search_v1_search_get_with_http_info(**kwargs)
            return data

    def search_v1_search_get_with_http_info(self, **kwargs):
        """
        Make Full Text Search and return found Documents
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.search_v1_search_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method search_v1_search_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'search_criteria_request_name' in params:
            query_params.append(('searchCriteria[requestName]', params['search_criteria_request_name']))
        ...
        return self.api_client.call_api('/V1/search', 'GET',
                                        ...
                                        response_type='FrameworkSearchSearchResultInterface',
