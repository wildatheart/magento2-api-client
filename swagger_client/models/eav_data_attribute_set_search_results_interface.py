...
class EavDataAttributeSetSearchResultsInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        EavDataAttributeSetSearchResultsInterface - a model defined in Swagger
        """
    ...
    def items(self, items):
        ...
        :type: list[EavDataAttributeSetInterface]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EavDataAttributeSetSearchResultsInterface):
            return False
