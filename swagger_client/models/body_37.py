...
class Body37(object):
    ...
    def prices(self):
        """
        Gets the prices of this Body37.

        :return: The prices of this Body37.
    ...
    def prices(self, prices):
        """
        Sets the prices of this Body37.

        :param prices: The prices of this Body37.
        :type: list[CatalogDataCostInterface]
        """
        if prices is None:
