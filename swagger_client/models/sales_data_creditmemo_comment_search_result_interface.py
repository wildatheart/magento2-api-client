...
class SalesDataCreditmemoCommentSearchResultInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        SalesDataCreditmemoCommentSearchResultInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SalesDataCreditmemoCommentSearchResultInterface):
            return False
