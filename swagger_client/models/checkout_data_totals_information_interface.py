...
class CheckoutDataTotalsInformationInterface(object):
    """
    ...
    def __init__(self, address=None, shipping_method_code=None, shipping_carrier_code=None, extension_attributes=None, custom_attributes=None):
        """
        CheckoutDataTotalsInformationInterface - a model defined in Swagger
        """
    ...
    def extension_attributes(self):
        ...
        :rtype: CheckoutDataTotalsInformationExtensionInterface
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CheckoutDataTotalsInformationInterface):
            return False
