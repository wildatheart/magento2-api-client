...
class CatalogDataProductWebsiteLinkInterface(object):
    """
    ...
    def __init__(self, sku=None, website_id=None):
        """
        CatalogDataProductWebsiteLinkInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CatalogDataProductWebsiteLinkInterface):
            return False
