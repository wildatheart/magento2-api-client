...
class TaxDataGrandTotalRatesInterface(object):
    """
    ...
    def __init__(self, percent=None, title=None):
        """
        TaxDataGrandTotalRatesInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TaxDataGrandTotalRatesInterface):
            return False
