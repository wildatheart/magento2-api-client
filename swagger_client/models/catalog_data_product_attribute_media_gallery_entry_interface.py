...
class CatalogDataProductAttributeMediaGalleryEntryInterface(object):
    ...
    def __init__(self, id=None, media_type=None, label=None, position=None, disabled=None, types=None, file=None, content=None, extension_attributes=None):
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CatalogDataProductAttributeMediaGalleryEntryInterface):
            return False
