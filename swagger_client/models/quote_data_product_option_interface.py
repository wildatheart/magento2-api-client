...
class QuoteDataProductOptionInterface(object):
    """
    ...
    def __init__(self, extension_attributes=None):
        """
        QuoteDataProductOptionInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, QuoteDataProductOptionInterface):
            return False
