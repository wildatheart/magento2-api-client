...
class CatalogDataCustomOptionInterface(object):
    """
    ...
    def __init__(self, option_id=None, option_value=None, extension_attributes=None):
        """
        CatalogDataCustomOptionInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CatalogDataCustomOptionInterface):
            return False
