...
class SalesRuleDataCouponSearchResultInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        SalesRuleDataCouponSearchResultInterface - a model defined in Swagger
        """
    ...
    def items(self, items):
        ...
        :type: list[SalesRuleDataCouponInterface]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SalesRuleDataCouponSearchResultInterface):
            return False
