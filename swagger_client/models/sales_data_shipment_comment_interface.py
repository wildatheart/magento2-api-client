...
class SalesDataShipmentCommentInterface(object):
    """
    ...
    def __init__(self, is_customer_notified=None, parent_id=None, extension_attributes=None, comment=None, is_visible_on_front=None, created_at=None, entity_id=None):
        """
        SalesDataShipmentCommentInterface - a model defined in Swagger
        """
    ...
    def extension_attributes(self):
        ...
        :rtype: SalesDataShipmentCommentExtensionInterface
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SalesDataShipmentCommentInterface):
            return False
