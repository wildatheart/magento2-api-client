...
class GiftMessageDataMessageExtensionInterface(object):
    """
    ...
    def __init__(self, entity_id=None, entity_type=None):
        """
        GiftMessageDataMessageExtensionInterface - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, GiftMessageDataMessageExtensionInterface):
            return False
