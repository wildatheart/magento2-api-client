...
class Body(object):
    ...
    def attribute_set(self):
        """
        Gets the attribute_set of this Body.

        :return: The attribute_set of this Body.
    ...
    def attribute_set(self, attribute_set):
        """
        Sets the attribute_set of this Body.

        :param attribute_set: The attribute_set of this Body.
