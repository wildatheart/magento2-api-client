...
class CmsDataBlockSearchResultsInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        CmsDataBlockSearchResultsInterface - a model defined in Swagger
        """
    ...
    def items(self, items):
        ...
        :type: list[CmsDataBlockInterface]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CmsDataBlockSearchResultsInterface):
            return False
