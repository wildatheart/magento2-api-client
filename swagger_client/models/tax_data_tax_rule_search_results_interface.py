...
class TaxDataTaxRuleSearchResultsInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        TaxDataTaxRuleSearchResultsInterface - a model defined in Swagger
        """
    ...
    def items(self, items):
        ...
        :type: list[TaxDataTaxRuleInterface]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TaxDataTaxRuleSearchResultsInterface):
            return False
