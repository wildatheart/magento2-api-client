...
class TaxDataTaxClassSearchResultsInterface(object):
    """
    ...
    def __init__(self, items=None, search_criteria=None, total_count=None):
        """
        TaxDataTaxClassSearchResultsInterface - a model defined in Swagger
        """
    ...
    def items(self, items):
        ...
        :type: list[TaxDataTaxClassInterface]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TaxDataTaxClassSearchResultsInterface):
            return False
