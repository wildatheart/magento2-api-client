...
class CatalogInventoryDataStockItemInterface(object):
    ...
    def __init__(self, item_id=None, product_id=None, stock_id=None, qty=None, is_in_stock=None, is_qty_decimal=None, show_default_notification_message=None, use_config_min_qty=None, min_qty=None, use_config_min_sale_qty=None, min_sale_qty=None, use_config_max_sale_qty=None, max_sale_qty=None, use_config_backorders=None, backorders=None, use_config_notify_stock_qty=None, notify_stock_qty=None, use_config_qty_increments=None, qty_increments=None, use_config_enable_qty_inc=None, enable_qty_increments=None, use_config_manage_stock=None, manage_stock=None, low_stock_date=None, is_decimal_divided=None, stock_status_changed_auto=None, extension_attributes=None):
        """
        ...
        self._show_default_notification_message = None
        ...
        self._use_config_qty_increments = None
        self._qty_increments = None
        self._use_config_enable_qty_inc = None
        self._enable_qty_increments = None
        self._use_config_manage_stock = None
        self._manage_stock = None
        self._low_stock_date = None
        self._is_decimal_divided = None
        self._stock_status_changed_auto = None
    ...
    def extension_attributes(self):
        ...
        :rtype: CatalogInventoryDataStockItemExtensionInterface
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CatalogInventoryDataStockItemInterface):
            return False
