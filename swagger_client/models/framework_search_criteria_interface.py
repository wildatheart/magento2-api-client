...
class FrameworkSearchCriteriaInterface(object):
    """
    ...
    def __init__(self, filter_groups=None, sort_orders=None, page_size=None, current_page=None):
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FrameworkSearchCriteriaInterface):
            return False
